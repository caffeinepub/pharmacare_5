...
export class Backend implements backendInterface {
    ...
    async addMedicine(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: bigint, arg6: bigint, arg7: number, arg8: bigint): Promise<string> {
        if (this.processError) {
            try {
    ...
    async addSupplier(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string): Promise<string> {
        if (this.processError) {
            try {
    ...
    async createSale(arg0: string, arg1: Array<SaleItem>, arg2: number): Promise<string> {
        if (this.processError) {
            try {
    ...
    async getExpiringMedicines(arg0: bigint): Promise<Array<Medicine>> {
        if (this.processError) {
            try {
    ...
    async getSale(arg0: string): Promise<Sale> {
        if (this.processError) {
            try {
    ...
    async updateMedicine(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: bigint, arg7: bigint, arg8: number, arg9: bigint, arg10: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateMedicine(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateSupplier(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: boolean): Promise<void> {
        if (this.processError) {
            try {
